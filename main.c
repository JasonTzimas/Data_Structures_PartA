...
struct user sentinel_node;
struct user_list User_List;
struct new_movie_list New_Movie_List;
struct movie_list* Movie_Category_Array[6];
...
void init_structures(void)
{
	...
	// Up to this point we have initialized our user_list struct and filled it with a sentinel_node
}
